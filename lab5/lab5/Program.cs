...
namespace lab5
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                IWriter writer = new FileWriter(@"C:\game\test2.txt");
                IWriter rsa = new DecRSA(writer);
                IWriter hash = new DecSHA512(rsa);
            ...
            {
                IWriter writer = new FileWriter(@"C:\game\test4.txt");
                IWriter rsa = new DecRSA(writer);
                IWriter hash = new DecMD5(rsa);
            ...
            {
                IWriter writer = new FileWriter(@"C:\game\test12.txt");
                IWriter rsa = new DecRSA(writer);
                IWriter hash = new DecSHA512(rsa);
                string? result = hash.Save("BBBBCCCCC");
            ...
            {
                IWriter writer = new FileWriter(@"C:\game\test13.txt");
                IWriter rsa = new DecRSA(writer);
                IWriter hash = new DecMD5(rsa);
                string? result = hash.Save("BBBBCCCCC");
